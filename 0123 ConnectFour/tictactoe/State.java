...
public class State
{
    ...
    private boolean checkConsecutiveFour(int startRow, int startCol, int rowIncrement, int colIncrement) {
        ...
        return true;
        // Credits to the author, my classmate, for this code.
    }
    ...
    public void resetGame() {
        ...
        REDName = "";
        YELLOWName = "";
        // Credits to the author, my classmate, for this code which fills all spaces with an indicated blank space, clearing it,
    }
